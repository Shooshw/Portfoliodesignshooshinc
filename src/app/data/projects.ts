...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image:
      "/imports/24kmagic images/Bruno-mars-album cover, finesse para web.webp",
    gallery: [
      "/imports/24kmagic images/Bruno-mars-album cover, finesse para web.webp",
      "/imports/24kmagic images/Free_Vinyl_Mockup_2.webp",
      "/imports/24kmagic images/VInil-1-bruno-mars.webp",
      "/imports/24kmagic images/VInil-2-bruno-mars.webp",
    ],
    translations: {
      en: {
        title: "24k Magic - Bruno Mars Fan cover",
