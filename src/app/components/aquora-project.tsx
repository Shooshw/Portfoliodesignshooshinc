...
export function AquoraProject({ project, onClose }: AquoraProjectProps) {
  ...
  const loc = {
    pt: {
      ...
      anxietyP1:
        "O homem contemporâneo lida com as consequências de uma vida acelerada, contraditória e agitada. O enfraquecimento de todas as metanarrativas perpetua sensações de",
      anxietyStrong: "vazio existencial",
      anxietyP1_2:
        ", onde o hiperespaço supera a capacidade humana de se localizar e a hipervalorização da imagem fortalece estados melancólicos.",
      ...
      anxietyP2_2:
        "também se mostra como fator agravante, potencializando insônia, inquietação e quadros clínicos como transtorno de ansiedade generalizada. Diante disso, a medicalização tornou-se uma saída crescente:",
      stat1:
        "caixas de calmantes vendidos diariamente no Brasil (Anvisa, 2022)",
      ...
      targetDesc:
        "Perfil que busca um refúgio digital e estruturação de hábitos saudáveis perante rotinas exigentes.",
      identityTitle: "Identidade Visual e Fluidez",
      paletteTitle: "Paleta de Cores",
      nunitoDesc:
        "Usada em títulos e chamadas, transmitindo proximidade e suavidade.",
      sansDesc:
        "Para corpos de texto longos. Alta legibilidade em telas pequenas de forma clara e amigável.",
      appsTitle: "Aplicações e Fundos",
      mindfulnessTitle: "Práticas de Mindfulness",
      mindfulnessDesc:
        "Estes são 3 exercícios disponíveis no modo SOS do aplicativo, desenvolvidos para momentos de crise. Práticas rápidas que ajudam a restabelecer o equilíbrio e aliviar sintomas de ansiedade instantaneamente.",
      sos: "SOS",
      ...
      mvpDesc:
        "Telas da nossa aplicação, projetadas com base no Design System para garantir fluidez, facilidade de uso e uma experiência focada na saúde mental, sem táticas de retenção abusiva.",
      ...
      mockupDesc:
        "Aplicações práticas da nova identidade visual em produtos físicos e espaços corporativos.",
      ...
      footerGradeDesc:
        "Apresentação, Projeto e Relatório avaliados com excelência pela banca.",
      members:
        "Integrantes: Vanessa Piaui, Maria Luiza, André Yuzo, Beatriz Wapf, Adria Manoela, Pedro Oliveira, e Mateus Pimentel.",
    },
    en: {
      ...
      anxietyP1:
        "Contemporary man deals with the consequences of an accelerated, contradictory, and agitated life. The weakening of all metanarratives perpetuates feelings of",
      anxietyStrong: "existential emptiness",
      anxietyP1_2:
        ", where hyperspace exceeds the human capacity to locate oneself, and the hypervaluation of image strengthens melancholic states.",
      ...
      anxietyP2_2:
        "also proves to be an aggravating factor, enhancing insomnia, restlessness, and clinical conditions such as generalized anxiety disorder. Given this, medicalization has become a growing way out:",
      ...
      targetDesc:
        "Profile seeking a digital refuge and structured healthy habits against demanding routines.",
      identityTitle: "Visual Identity and Fluidity",
      paletteTitle: "Color Palette",
      nunitoDesc:
        "Used in titles and headings, conveying closeness and softness.",
      sansDesc:
        "For long body texts. High readability on small screens in a clear and friendly way.",
      appsTitle: "Applications and Backgrounds",
      mindfulnessTitle: "Mindfulness Practices",
      mindfulnessDesc:
        "These are 3 exercises available in the app's SOS mode, developed for moments of crisis. Quick practices that help restore balance and relieve anxiety symptoms instantly.",
      sos: "SOS",
      ...
      mvpDesc:
        "Screens of our application, designed based on the Design System to ensure fluidity, ease of use, and an experience focused on mental health, without abusive retention tactics.",
      ...
      mockupDesc:
        "Practical applications of the new visual identity in physical products and corporate spaces.",
      ...
      footerGradeDesc:
        "Presentation, Project, and Report evaluated with excellence by the board.",
      members:
        "Members: Vanessa Piaui, Maria Luiza, André Yuzo, Beatriz Wapf, Adria Manoela, Pedro Oliveira, and Mateus Pimentel.",
    },
  };
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 z-50 flex items-center justify-between p-6 bg-white/20 backdrop-blur-md border-b border-white/40">
        <button
          className="font-['Nunito'] font-bold text-lg text-[#2d4059]"
          onClick={onClose}
        >
          Shoosh.inc
        </button>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 flex flex-col gap-24">
        ...
        <section className="flex flex-col items-center text-center mt-10 relative">
          ...
          <motion.div className="relative z-20 mt-12 bg-white/10 backdrop-blur-md px-10 py-6 rounded-[2rem] border border-white/20 shadow-2xl">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="flex flex-col gap-6">
              <p className="text-[#2d4059] text-lg font-light leading-relaxed">
                {tLoc.anxietyP1} <strong>{tLoc.anxietyStrong}</strong>
                {tLoc.anxietyP1_2}
              </p>
              <div className="bg-teal-900/5 p-6 rounded-2xl border border-teal-900/10 relative overflow-hidden group hover:bg-teal-900/10 transition-colors">
                ...
                <p className="text-sm font-bold text-teal-800 mt-3 pl-4">
                  {tLoc.quoteAuthor}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <p className="text-[#2d4059] text-lg font-light leading-relaxed">
                {tLoc.anxietyP2} <strong>{tLoc.anxietyStrong2}</strong>{" "}
                {tLoc.anxietyP2_2}
              </p>
              <div className="grid grid-cols-2 gap-4 mt-2">
                <div className="bg-white/40 p-5 rounded-2xl border border-white/60 shadow-sm hover:scale-105 transition-transform">
                  ...
                  <p className="text-xs text-[#2d4059]/80 mt-1 leading-tight">
                    {tLoc.stat1}
                  </p>
                </div>
                <div className="bg-white/40 p-5 rounded-2xl border border-white/60 shadow-sm hover:scale-105 transition-transform">
        ...
        <section className="bg-white/30 backdrop-blur-xl border border-white/50 rounded-[3rem] p-10 md:p-16 shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[tLoc.target1, tLoc.target2, tLoc.target3].map((audience, i) => (
              <div
                key={i}
                className="bg-white/40 p-8 rounded-3xl border border-white/60 hover:scale-105 hover:bg-white/60 hover:shadow-lg transition-all duration-300"
              >
        ...
        <section className="flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[800px]">
            ...
            <div className="bg-white/40 backdrop-blur-xl rounded-[3rem] border border-white/60 p-8 flex flex-col items-center justify-center group overflow-hidden">
              <h4 className="font-bold text-lg text-teal-800 mb-6 z-10 relative">
                {tLoc.paletteTitle}
              </h4>
            ...
            <div className="bg-white/40 backdrop-blur-xl rounded-[3rem] border border-white/60 p-10 flex flex-col justify-center overflow-hidden relative group">
              <div className="absolute -top-4 -right-4 opacity-[0.03] font-['Nunito'] font-black text-[12rem] pointer-events-none group-hover:scale-110 group-hover:rotate-6 transition-transform duration-700">
                Aa
              </div>
              <h4 className="font-['Nunito'] font-black text-6xl text-teal-800 tracking-tight mb-8">
                Aa
              </h4>
              <div className="space-y-6 relative z-10">
                <div>
                  <p className="font-['Nunito'] font-bold text-2xl text-teal-700">
                    Nunito
                  </p>
                  <p className="font-['Nunito'] text-teal-700/60 text-sm mt-1 leading-relaxed">
                    {tLoc.nunitoDesc}
                  </p>
                </div>
                <div className="h-px w-full bg-teal-800/10" />
                <div>
                  <p className="font-['Open_Sans'] font-semibold text-xl text-[#3b5973]">
                    Open Sans
                  </p>
                  <p className="font-['Open_Sans'] text-[#5f7a94] text-sm mt-1 leading-relaxed">
                    {tLoc.sansDesc}
                  </p>
                </div>
              </div>
          ...
          <div className="relative w-full overflow-hidden bg-gray-50/50 rounded-2xl p-6 md:p-12 flex justify-center items-center h-auto min-h-[400px]">
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-4 w-full max-w-5xl justify-center items-stretch h-full">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 flex-1">
                {/* Row 1 */}
                <div
                  className="aspect-square rounded-xl bg-gradient-to-br from-[#12c2e9] to-[#c471ed]"
                  style={{
                    background:
                      "linear-gradient(135deg, #1bd3cf 0%, #17cbb8 100%)",
                  }}
                />
                <div
                  className="aspect-square rounded-xl bg-gradient-to-br from-[#6a11cb] to-[#2575fc]"
                  style={{
                    background:
                      "linear-gradient(135deg, #5956d7 0%, #7d3ac1 100%)",
                  }}
                />
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #df649f 0%, #eb8485 100%)",
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #11cd58 0%, #0abf45 100%)",
                  }}
                >
                ...
                {/* Row 2 */}
                <div
                  className="aspect-square rounded-xl relative overflow-hidden flex items-end"
                  style={{
                    background:
                      "linear-gradient(180deg, #d3957f 0%, #7db18c 100%)",
                  }}
                >
                  <svg
                    className="absolute w-full h-[150%] inset-0 opacity-40"
                    viewBox="0 0 100 100"
                    preserveAspectRatio="none"
                  >
                    <path
                      d="M0,40 Q25,60 50,40 T100,50 L100,100 L0,100 Z"
                      fill="#fff"
                    />
                    <path
                      d="M0,60 Q30,80 60,50 T100,70 L100,100 L0,100 Z"
                      fill="#fff"
                      opacity="0.8"
                    />
                  </svg>
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, #4dc4d4 0%, #209995 100%)",
                  }}
                >
                  <svg
                  ...
                  >
                    <path
                      d="M0,30 Q30,50 60,30 T100,40 L100,100 L0,100 Z"
                      fill="#fff"
                    />
                    <path
                      d="M0,60 Q40,80 70,50 T100,70 L100,100 L0,100 Z"
                      fill="#135a58"
                      opacity="0.6"
                    />
                  </svg>
                ...
                <div
                  className="aspect-square rounded-xl bg-gradient-to-br from-[#c389f9] to-[#b375f4] relative overflow-hidden"
                  style={{
                    background:
                      "linear-gradient(135deg, #ce8ffb 0%, #aa71f8 100%)",
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, #155f86 0%, #2b4961 100%)",
                  }}
                >
              ...
              <div className="grid grid-cols-2 gap-4 flex-[0.5] min-w-[150px] md:min-w-[200px]">
                {/* Light Vertical */}
                <div
                  className="h-full min-h-[250px] rounded-xl relative overflow-hidden"
                  style={{
                    background:
                      "linear-gradient(180deg, #d3eaf9 0%, #6ab2f2 100%)",
                  }}
                >
                  <svg
                    className="absolute top-0 w-full h-1/2 opacity-30"
                    viewBox="0 0 100 100"
                    preserveAspectRatio="none"
                  >
                    <path
                      d="M0,20 Q25,40 50,20 T100,30 L100,0 L0,0 Z"
                      fill="#fff"
                    />
                    <path
                      d="M0,35 Q30,50 60,35 T100,45 L100,0 L0,0 Z"
                      fill="#fff"
                      opacity="0.6"
                    />
                  </svg>
                  ...
                  >
                    <path
                      d="M0,100 L100,100 L100,60 Q75,40 50,60 T0,70 Z"
                      fill="#46d467"
                    />
                    <path
                      d="M-20,100 L120,100 L120,75 Q50,45 10,75 Z"
                      fill="#28ad45"
                    />
                  </svg>
                </div>
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, #095079 0%, #10314a 100%)",
                  }}
                >
                  ...
                  <svg
                    className="absolute bottom-0 w-full h-1/3 opacity-80"
                    viewBox="0 0 100 100"
                    preserveAspectRatio="none"
                  >
                    <path
                      d="M0,100 L100,100 L100,50 Q75,30 50,50 T0,40 Z"
                      fill="#051f30"
                    />
                  </svg>
                </div>
        ...
        <section className="bg-white/30 backdrop-blur-xl border border-white/50 rounded-[3rem] p-10 md:p-16 shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
          ...
          <p className="text-teal-800/80 text-lg mb-8 max-w-3xl">
            {tLoc.mindfulnessDesc.split("SOS")[0]}
            <strong className="font-bold text-teal-900">{tLoc.sos}</strong>
            {tLoc.mindfulnessDesc.split("SOS")[1]}
          </p>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-white/70 text-sm mb-4 transition-all duration-500 group-hover:text-white/95 group-hover:animate-[pulse_3s_ease-in-out_infinite]">
                {tLoc.ex1Desc}
              </p>
        ...
        <section className="bg-white/30 backdrop-blur-xl border border-white/50 rounded-[3rem] p-10 md:p-16 shadow-[0_20px_50px_rgba(0,0,0,0.05)] mt-12 mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 relative items-start">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-center font-bold text-teal-800 text-sm mt-2">
                {tLoc.homeQuick}
              </p>
            </div>
        ...
        <section className="bg-white/30 backdrop-blur-xl border border-white/50 rounded-[3rem] p-10 md:p-16 shadow-[0_20px_50px_rgba(0,0,0,0.05)] mt-12 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="group overflow-hidden rounded-3xl relative h-[400px] shadow-sm hover:shadow-xl transition-all duration-500">
              <img
                loading="lazy"
                src="/images/Captura_de_tela_2026-05-11_001637.webp"
            ...
            <div className="group overflow-hidden rounded-3xl relative h-[400px] shadow-sm hover:shadow-xl transition-all duration-500 bg-white">
              <img
                loading="lazy"
                src="/images/Captura_de_tela_2026-05-11_002534.webp"
                alt={tLoc.supportMat}
            ...
            <div className="md:col-span-2 group overflow-hidden rounded-3xl relative h-[500px] shadow-sm hover:shadow-xl transition-all duration-500 border border-white/50">
              <img
                loading="lazy"
                src="/images/Captura_de_tela_2026-05-11_001645.webp"
                alt={tLoc.officeRec}
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
              />
        ...
        <section className="bg-gradient-to-br from-teal-800 to-blue-900 text-white p-16 rounded-[3rem] text-center shadow-2xl relative overflow-hidden">
          ...
          <h3 className="font-['Nunito'] text-2xl font-bold mb-4 relative z-10">
            {tLoc.footerTitle}
          </h3>
