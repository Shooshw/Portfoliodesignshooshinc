      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 flex flex-col gap-24">
        ...
        <section className="flex flex-col items-center text-center mt-10 relative">
          <div className="relative flex justify-center items-center h-64 w-full">
            ...
            <img src="/src/assets/images/regenerated_image_1778466713759.png" alt="Aquora Logo" className="relative z-10 w-48 h-48 object-contain drop-shadow-xl p-2" />
          </div>
        ...
        <section className="flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[800px]">
            ...
            <div className="md:col-span-2 md:row-span-2 bg-white/40 backdrop-blur-xl rounded-[3rem] border border-white/60 p-8 flex items-center justify-center overflow-hidden relative">
              ...
              <img src="/src/assets/images/regenerated_image_1778466713759.png" alt="Aquora Logo" className="relative z-10 w-full h-full object-contain p-12 drop-shadow-2xl" />
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 relative items-start">
            ...
            <div className="flex flex-col gap-2">
              <div className="group relative w-full aspect-[9/16] bg-gradient-to-b from-gray-100 to-gray-200/50 rounded-[1.5rem] border border-white mx-auto shadow-md overflow-hidden flex items-center justify-center p-4">
                <img src="/src/assets/images/regenerated_image_1778442010151.png" alt={tLoc.homeLogin} className="w-full h-full object-contain rounded-md transition-transform duration-700 group-hover:scale-105" />
              </div>
            ...
            <div className="flex flex-col gap-2 mt-6 md:mt-0">
              <div className="group relative w-full aspect-[9/16] bg-gradient-to-b from-gray-100 to-gray-200/50 rounded-[1.5rem] border border-white mx-auto shadow-md overflow-hidden flex items-center justify-center p-4">
                <img src="/src/assets/images/regenerated_image_1778442012973.png" alt={tLoc.sleepConfig} className="w-full h-full object-contain rounded-md transition-transform duration-700 group-hover:scale-105" />
              </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="group relative w-full aspect-[9/16] bg-gradient-to-b from-gray-100 to-gray-200/50 rounded-[1.5rem] border border-white mx-auto shadow-md overflow-hidden flex items-center justify-center p-4">
                <img src="/src/assets/images/regenerated_image_1778442015485.png" alt={tLoc.routineMon} className="w-full h-full object-contain rounded-md transition-transform duration-700 group-hover:scale-105" />
              </div>
            ...
            <div className="flex flex-col gap-2 mt-6 md:mt-0">
              <div className="group relative w-full aspect-[9/16] bg-gradient-to-b from-gray-100 to-gray-200/50 rounded-[1.5rem] border border-white mx-auto shadow-md overflow-hidden flex items-center justify-center p-4">
                <img src="/src/assets/images/regenerated_image_1778442017180.png" alt={tLoc.emergency} className="w-full h-full object-contain rounded-md transition-transform duration-700 group-hover:scale-105" />
              </div>
        ...
        <section className="bg-white/30 backdrop-blur-xl border border-white/50 rounded-[3rem] p-10 md:p-16 shadow-[0_20px_50px_rgba(0,0,0,0.05)] mt-12 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <div className="group overflow-hidden rounded-3xl relative h-[400px] shadow-sm hover:shadow-xl transition-all duration-500">
                <img src="/src/assets/images/Captura de tela 2026-05-11 001637.png" alt={tLoc.variousApps} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
             ...
             <div className="group overflow-hidden rounded-3xl relative h-[400px] shadow-sm hover:shadow-xl transition-all duration-500 bg-white">
                <img src="/src/assets/images/Captura de tela 2026-05-11 002534.png" alt={tLoc.supportMat} className="w-full h-full object-contain p-4 transition-transform duration-700 group-hover:scale-105" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
             ...
             <div className="md:col-span-2 group overflow-hidden rounded-3xl relative h-[500px] shadow-sm hover:shadow-xl transition-all duration-500 border border-white/50">
                <img src="/src/assets/images/Captura de tela 2026-05-11 001645.png" alt={tLoc.officeRec} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
