    ...
    <section id="education" className={`py-32 ${bg}`}>
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <p
            className={`mt-6 font-sans text-lg opacity-40 max-w-xl mx-auto leading-relaxed ${textPrimary}`}
          >
              ...
              >
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <h3
                      className={`font-display font-semibold text-2xl mb-1 group-hover:text-[#C8392B] transition-colors ${textPrimary}`}
                    >
                      {edu.title}
                    </h3>
                    <p
            ...
            <div className="space-y-6">
              {certifications.map((cert, index) => (
                <div key={index} className="flex gap-4 items-start">
                  ...
                  <p
                    className={`font-sans text-sm leading-relaxed opacity-60 ${textPrimary}`}
                  >
                    {cert}
                  </p>
                </div>
