    ...
    <div className={`min-h-screen py-32 transition-colors duration-700 ${bg}`}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h1 className={`font-display font-semibold italic text-[clamp(3.5rem,8vw,5.5rem)] tracking-tighter leading-[0.85] mb-8 ${textPrimary}`}>
            {t("contact.title1")} <span className="opacity-30">{t("contact.title2")}</span>
          </h1>
          <p className={`font-sans text-xl opacity-40 max-w-2xl mx-auto leading-relaxed ${textPrimary}`}>
            {t("contact.subtitle")}
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-12 xl:col-span-4 space-y-8">
            ...
            >
              <h3 className={`font-display font-semibold italic text-2xl mb-10 ${textPrimary}`}>{t("contact.getInTouch")}</h3>
              <div className="space-y-6">
                ...
                >
                  ...
                  <div className="text-left">
                    <p className={`font-sans text-[0.6rem] font-bold tracking-[0.2em] uppercase mb-1 ${textMuted}`}>{t("contact.email")}</p>
                    <p className={`font-sans text-sm font-bold ${textPrimary}`}>pedroolip13@gmail.com</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-left">
                    <p className={`font-sans text-[0.6rem] font-bold tracking-[0.2em] uppercase mb-1 ${textMuted}`}>{t("contact.linkedin")}</p>
                    <p className={`font-sans text-sm font-bold ${textPrimary}`}>/in/pedro-oliveira-55a3b123a</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div className="text-left">
                    <p className={`font-sans text-[0.6rem] font-bold tracking-[0.2em] uppercase mb-1 ${textMuted}`}>{t("contact.whatsapp")}</p>
                    <p className={`font-sans text-sm font-bold ${textPrimary}`}>+55 (11) 99758-9393</p>
                  </div>
                </a>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className={`p-10 rounded-[3rem] border ${surface} ${border}`}
            >
              <h3 className={`font-display font-semibold italic text-2xl mb-8 ${textPrimary}`}>{t("contact.availability")}</h3>
              <div className="space-y-8">
                <div className="flex items-center gap-6 group">
                   ...
                   <div>
                      <p className={`font-sans text-[0.6rem] font-bold tracking-[0.2em] uppercase mb-1 ${textMuted}`}>{t("contact.responseTime")}</p>
                      <p className={`font-sans text-xs font-bold leading-relaxed ${textPrimary}`}>{t("contact.within24h")}</p>
                   </div>
                </div>
                <div className="flex items-center gap-6 group">
                   <div className="p-3 rounded-2xl bg-[#C8392B]/5 text-[#C8392B] border border-[#C8392B]/10">
                   ...
                   <div>
                      <p className={`font-sans text-[0.6rem] font-bold tracking-[0.2em] uppercase mb-1 ${textMuted}`}>{t("contact.location")}</p>
                      <p className={`font-sans text-xs font-bold leading-relaxed ${textPrimary}`}>{t("contact.remote")}</p>
                   </div>
                </div>
              </div>
            </motion.div>
          ...
          <div className="lg:col-span-12 xl:col-span-8 space-y-12">
            ...
            >
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className={`font-display font-semibold italic text-3xl md:text-4xl ${textPrimary}`}>{t("contact.scheduleTitle")}</h3>
                </div>
                <p className={`font-sans text-lg opacity-60 mb-10 max-w-xl leading-relaxed ${textPrimary}`}>
                  {t("contact.scheduleDesc")}
                </p>
                <button
                  onClick={() => window.open("https://cal.com/shoosh", "_blank")}
            ...
            >
               <h3 className={`font-display font-semibold italic text-3xl mb-12 ${textPrimary}`}>{t("contact.sendMessage")}</h3>
               
               <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      <label htmlFor="name" className={`font-sans text-[0.65rem] font-bold tracking-[0.2em] uppercase px-2 ${textMuted}`}>{t("contact.fullName")}</label>
                      <input
                        id="name"
                        type="text"
                        required
                    ...
                    <div className="space-y-3">
                      <label htmlFor="email" className={`font-sans text-[0.65rem] font-bold tracking-[0.2em] uppercase px-2 ${textMuted}`}>{t("contact.emailAddress")}</label>
                      <input
                        id="email"
                        type="email"
                        required
                  ...
                  <div className="space-y-3">
                    <label htmlFor="subject" className={`font-sans text-[0.65rem] font-bold tracking-[0.2em] uppercase px-2 ${textMuted}`}>{t("contact.subject")}</label>
                    <input
                      id="subject"
                      type="text"
                      required
                  ...
                  <div className="space-y-3">
                    <label htmlFor="message" className={`font-sans text-[0.65rem] font-bold tracking-[0.2em] uppercase px-2 ${textMuted}`}>{t("contact.message")}</label>
                    <textarea
                      id="message"
                      required
                      rows={6}
