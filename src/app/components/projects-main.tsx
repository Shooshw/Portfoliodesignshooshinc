          ...
          {mainProjects.map((project, index) => {
            ...
            >
              <div className="relative h-[420px] overflow-hidden bg-[#0D0D0D]">
                {isAquora ? (
                   <>
                     <img loading="lazy" src="/images/regenerated_image_1778465979958.png" alt="Aquora" className="absolute inset-0 w-full h-full object-contain p-8 bg-gradient-to-tr from-[#fdfbfb] via-[#e2ebf0] to-[#fdfbfb] transition-transform duration-700 z-10 group-hover:opacity-0" />
                     <video preload="metadata" src="/images/List-9-16.mp4" loop playsInline muted className="absolute inset-0 w-full h-full object-cover scale-[1.10] group-hover:scale-[1.13] transition-transform duration-700 z-0" />
                   </>
                ) : isLol ? (
                   <>
                     <img loading="lazy" src="/images/regenerated_image_1778283536856.png" alt="LoL" className="absolute inset-0 w-full h-full object-cover scale-[1.5] transition-transform duration-700 z-10 group-hover:opacity-0" />
                     <video preload="metadata" src="/images/1668457441-1668457441-neeko-the-curious-chameleon-live-wallpaper.mp4" loop playsInline muted className="absolute inset-0 w-full h-full object-cover scale-[1.5] transition-transform duration-700 z-0" />
                   </>
                ) : project.image ? (
                  <ImageWithFallback
                    src={project.image}
